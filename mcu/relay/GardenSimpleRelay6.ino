...
<section class="panel"><h2>Test Remote API</h2><p>Run an immediate connectivity/authentication test using the currently saved remote API settings.</p><div class="actions"><button onclick="testRemote()">Test Remote API</button></div></section>
